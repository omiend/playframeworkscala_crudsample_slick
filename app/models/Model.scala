...
/** Parent */
case class Parent(id: Option[Long] = None, name: String, createDate: DateTime, updateDate: DateTime)
object Parent {
...
/** Child */
case class Child(id: Option[Long] = None, name: String, parentId: Option[Long] = None, createDate: DateTime, updateDate: DateTime)
object Child {
